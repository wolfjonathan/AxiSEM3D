...
This is to be followed loosely and likely needs small adaptation in
every release. The only important step is bumping the version info in
a single commit and tagging this commit.

1. Determine a new version roughly following semantic versioning: http://semver.org/
...
2. Create a PR to update the changelog for the release, add a header for the current release - wait for merge
...
8. Create a release on GitHub: https://github.com/AxiSEMunity/AxiSEM3D/releases/new
   - include changelog
